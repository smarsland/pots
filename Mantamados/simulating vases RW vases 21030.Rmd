...
and then we will make 500 virtual vases by gluing together the variables from each run and timestep.
```````{r}
s5<-s5%>%
...
get the profile of the original average Mantamados vase
